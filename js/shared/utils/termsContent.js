...
export const TERMS_EFFECTIVE_DATE = '2026-03-06';
    ...
    return `
        ...
        <div>
            ...
            <ul class="list-disc list-inside space-y-0.5 text-xs text-gray-500">
                ...
                <li>"개인코드"란 교사가 학생에게 발급하는 4자리 접속 코드를 말합니다</li>
            </ul>
        </div>
        <div>
            <p class="font-semibold text-gray-700 mb-1">제3조 (서비스 내용)</p>
            <ul class="list-disc list-inside space-y-0.5 text-xs text-gray-500">
                <li>펫 키우기를 활용한 학급 관리 시스템</li>
                <li>감정 메시지를 통한 학생 정서 관리</li>
                <li>학급 운영 툴킷: 시간표, 알림장, 칭찬, 학급온도계, 선생님의 한마디</li>
        ...
        <div>
            ...
            <ul class="list-disc list-inside space-y-0.5 text-xs text-gray-500">
                ...
                <li>학생은 별도의 계정 가입 절차 없이, 교사가 발급한 개인코드를 통해 서비스에 접속합니다</li>
        ...
        <div>
            ...
            <ul class="list-disc list-inside space-y-0.5 text-xs text-gray-500">
                ...
                <li>학생 계정(개인코드)은 교사가 생성 및 관리하며, 교사는 학생 개인정보 보호를 위해 최선을 다해야 합니다</li>
        ...
        <div>
            ...
            <ul class="list-disc list-inside space-y-0.5 text-xs text-gray-500">
                ...
                <li>학생의 개인정보가 적절히 보호되도록 관리할 의무가 있습니다</li>
    ...
    return `
        ...
        <div>
            ...
            <ul class="list-disc list-inside space-y-0.5 text-xs text-gray-500">
                ...
                <li>학생 계정은 교사가 개인코드를 통해 간접적으로 생성·관리하며, 별도의 회원가입 절차가 없습니다</li>
                <li>학생 정보의 입력 및 관리 책임은 해당 교사에게 있습니다</li>
        ...
        <div>
            ...
            <ul class="list-disc list-inside space-y-0.5 text-xs text-gray-500 mb-2">
                <li>접속 로그, localStorage 데이터 (브라우저 기기 내 저장, 세션 관리 및 캐시 용도, 브라우저 설정에서 삭제 가능)</li>
            </ul>
            <p class="text-xs text-gray-500"><strong>수집하지 않는 정보:</strong> 주민등록번호, 전화번호, 주소 등 민감 개인정보</p>
        </div>
        <div>
        ...
        <div>
            ...
            <ul class="list-disc list-inside space-y-0.5 text-xs text-gray-500">
                ...
                <li>교사는 설정 화면에서 학급 데이터 및 계정을 직접 삭제할 수 있습니다</li>
        ...
        <div>
            ...
            <ul class="list-disc list-inside space-y-0.5 text-xs text-gray-500">
                <li>성명: 클래스펫 운영자</li>
                <li>이메일: classpet_help@gmail.com</li>
                <li>개인정보 관련 문의, 불만, 권리 행사는 위 이메일로 연락해 주시면 지체 없이 처리하겠습니다</li>
            </ul>
        </div>
        <div>
            <p class="font-semibold text-gray-700 mb-1">제10조 (학생 정보 관리)</p>
            <ul class="list-disc list-inside space-y-0.5 text-xs text-gray-500">
                <li>학생 이름의 입력 내용 및 관리에 대한 책임은 해당 교사에게 있습니다</li>
                <li>서비스는 최소한의 개인정보만으로 모든 기능을 정상적으로 이용할 수 있도록 설계되어 있습니다</li>
            </ul>
        </div>
        <div>
            <p class="font-semibold text-gray-700 mb-1">제11조 (사용자 의무 및 책임)</p>
            <ul class="list-disc list-inside space-y-0.5 text-xs text-gray-500">
                <li>교사는 학생의 개인정보 보호를 위해 최선을 다하여야 합니다</li>
        ...
        <div>
            ...
            <ul class="list-disc list-inside space-y-0.5 text-xs text-gray-500">
                <li>본 방침을 변경할 경우, 시행일 7일 전 서비스 내에서 공지합니다. 다만, 이용자의 권리에 중대한 변경이 있는 경우 최소 30일 전에 고지합니다</li>
                <li>개인정보 침해 관련 외부 구제기관: 개인정보침해신고센터 (전화 118, privacy.kisa.or.kr), 개인정보분쟁조정위원회 (kopico.go.kr), 대검찰청 사이버범죄수사과 (전화 1301, www.spo.go.kr), 경찰청 사이버수사국 (전화 182, ecrm.cyber.go.kr)</li>
                <li>시행일: ${TERMS_EFFECTIVE_DATE}</li>
            </ul>
        </div>
    `;
